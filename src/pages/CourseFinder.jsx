...
//           {/* Left Panel */}
//           <motion.div
//             className="bg-blue-700 text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden order-2 md:order-1"
//             initial={{ opacity: 0, x: -20 }}
//             animate={{ opacity: 1, x: 0 }}
//             transition={{ duration: 0.5 }}
//           >
...
//           {/* Right Panel */}
//           <motion.div
//             className="bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-sm order-1 md:order-2"
//             initial={{ opacity: 0, x: 20 }}
//             animate={{ opacity: 1, x: 0 }}
//             transition={{ duration: 0.5 }}
//           >
